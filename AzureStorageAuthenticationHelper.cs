...
namespace StorageRestApiAuth
{
    ...
    public static class AzureStorageAuthenticationHelper
    {
        ...
        public static AuthenticationHeaderValue GetAuthorizationHeader(
           ...
           HttpRequestMessage httpRequestMessage, string ifMatch = "", string md5 = "", string contentType = "")
        {
            string contentLength;
            try
            {
                contentLength = httpRequestMessage.Content.Headers.ContentLength.ToString();
            }
            catch
            {
                contentLength = "";
